                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-striped dt-responsive nowrap" width="100%">
                                            ...
                                            <tbody>
                                                <?php
                                                $data = daftar_kelas($_SESSION['angkatan'], $_SESSION['ambalan']);
                                                $no=1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group mb-2">
                                                            <a href="<?php echo $domain.'kelas/hapus/'.$row['id'];?>" class="btn btn-danger"><i class="mdi mdi-delete"></i></a>
                                                            <a href="<?php echo $domain.'kelas/edit/'.$row['id'];?>" class="btn btn-success"><i class="mdi mdi-playlist-edit"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <?php
