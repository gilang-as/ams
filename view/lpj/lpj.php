                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="header-title">Daftar Laporan</h4>
                                        <p class="text-muted font-14 mb-4">
                                            Daftar Laporan yang sudah di inputkan oleh pengguna yang memiliki akses.
                                        </p>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="header-title">Cetak Daftar pROPOSAL</h4>
                                        <p class="text-muted">
                                            Cetak Daftar Proposal yang sudah di inputkan berdasarkan tahun angkatan.
                                        </p>
