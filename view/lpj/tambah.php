...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Tambah Laporan - Responsive Bootstrap 4 Admin Dashboard</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Lapora Pertanggung Jawaban</h4>
                                </div>
                            </div>
                        </div>     
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Tambah Proposal</h4>
                                        <p class="text-muted">
                                            Tambahkan Proposal.
                                        </p>
