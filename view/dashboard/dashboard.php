<!DOCTYPE html>
    ...
    <head>
        <meta charset="utf-8" />
        <title>Dashboard - Ambalan Management System</title>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="<?php echo $domain;?>assets/images/ams-icon.png">

        <!-- third party css -->
        <link href="<?php echo $domain;?>assets/css/vendor/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css" />
        <!-- third party css end -->
    ...
    <body>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                ...
                                                <h5 class="text-muted font-weight-normal mt-0" title="Number of Customers">Proposal</h5>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                ...
                                                <h5 class="text-muted font-weight-normal mt-0" title="Number of Orders">Laporan</h5>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                ...
                                                <h5 class="text-muted font-weight-normal mt-0" title="Average Revenue">Surat Masuk</h5>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                ...
                                                <h5 class="text-muted font-weight-normal mt-0" title="Growth">Surat Keluar</h5>
        ...
        <script src="<?php echo $domain;?>assets/js/vendor/jquery-jvectormap-1.2.2.min.js"></script>
        <script src="<?php echo $domain;?>assets/js/vendor/jquery-jvectormap-world-mill-en.js"></script>
        <!-- third party js ends -->

        <!-- demo app -->
        <script src="<?php echo $domain;?>assets/js/pages/demo.dashboard.js"></script>
        <!-- end demo js-->
    </body>
</html>