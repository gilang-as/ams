                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">
                                            Daftar Surat Masuk yang sudah di inputkan oleh pengguna yang memiliki akses.
                                        </p>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="header-title">Cetak Daftar Surat Masuk</h4>
                                        <p class="text-muted">
                                            Cetak daftar surat masuk yang sudah di inputkan berdasarkan tahun angkatan.
                                        </p>
