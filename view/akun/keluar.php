...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Keluar - Ambalan Management System</title>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center w-75 m-auto">
                                    <h4 class="text-dark-50 text-center mt-0 font-weight-bold">Sampai jumpa kembali!</h4>
                                    <p class="text-muted mb-4">Kamu Berhasil Keluar</p>
                                </div>
