  <header id="header" class="header">
    <div class="header-top bg-light sm-text-center style-bordered">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div class="widget">
              <i class="fa fa-clock-o text-theme-colored"></i> SMA N 1 Harapan Pelita Jaya
            </div>
          </div>
          <div class="col-md-6">
            <div class="widget">
              <ul class="list-inline pull-right flip sm-pull-none sm-text-center list-bordered">
                <li class="bg-theme-colored text-white mb-xs-5"><a class="text-white" href="#"><i class="fa fa-facebook"></i> Facebook</a></li>
                <li class="bg-theme-colored3 text-white mb-xs-5"><a class="text-white" href="#"><i class="fa fa-instagram"></i> Instagram</a></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="header-nav">
      <div class="header-nav-wrapper navbar-scrolltofixed bg-white">
        <div class="container">
          <nav id="menuzord-right" class="menuzord orange no-bg"><a class="menuzord-brand pull-left flip mb-15" href="index-mp-layout1.html"><img src="images/logo-wide.png" alt=""></a>
            <ul class="menuzord-menu">
              <li class=""><a href="#home">Ambalan</a>
                <ul class="dropdown">
                  <li><a href="index-sp-layout1.html">Singlepage Layout</a></li>
                  <li><a href="index-rtl-layout1.html">RTL Layout</a></li>
                </ul>
              </li>
              ...
              <li><a href="javascript:void(0)">Materi</a>
                <div class="megamenu">
                  <div class="megamenu-row">
                    <div class="col3">
